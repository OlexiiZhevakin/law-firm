...
export async function generateMetadata({
  ...
  return {
    ...
    // 👇 ДОДАНО БЛОК ІКОНОК ДЛЯ GOOGLE 👇
    icons: {
      icon: [
        { url: "/favicon.ico", sizes: "32x32" }, // Для звичайних вкладок браузера
        { url: "/icon.png", type: "image/png", sizes: "192x192" }, // КРИТИЧНО ДЛЯ GOOGLE (розмір кратний 48px)
      ],
      apple: [
        { url: "/apple-icon.png", sizes: "180x180", type: "image/png" }, // Для пристроїв Apple
      ],
    },
    // 👆 -------------------------------- 👆
